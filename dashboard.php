...
<section class="dashboard">
   ...
   <?php
      ...
      ?>
      <h3><?= $numbers_of_orders; ?>/<span><?= $total_pendings; ?></span><span>IQD</span></h3>
      <p>Total Pendings</p>
   ...
   <?php
      ...
      ?>
      <h3><?= $numbers_of_orders; ?>/<span><?= $total_completes; ?></span><span>IQD</span></h3>
      <p>Total Completes</p>
      <a href="placed_orders.php" class="btn">see orders</a>
   </div>
   <div class="box">
   ...
   <div class="box">
      ...
      <p>Foods Added</p>
      <a href="products.php" class="btn">see foods</a>
   </div>
   <div class="box">
      <?php
